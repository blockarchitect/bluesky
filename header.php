    ...
    <sticky-header data-sticky-type="always">
      <header class="header-1 header-floating bg-cover" style="background-image: url(assets/img/footer/footer-bg-large.jpg) !important; background-size: cover; background-position: center; background-repeat: no-repeat">
              ...
              <nav class="header-nav drawer-menu">
                ...
                <ul class="header-menu list-unstyled">
                  ...
                  <li class="nav-item nav-item-static">
                    <a class="menu-link menu-link-main menu-accrodion" href="services.php" >
                      Services
                  ...
                  <li class="nav-item">
                    <a class="menu-link menu-link-main" href="contact.php"> Contact </a>
                  </li>
                </ul>
              </nav>
            </drawer-menu>
            <div class="header-actions d-flex align-items-center">
              <a href="contact.php" aria-label="contact us" class="button button--secondary button--slim d-none d-lg-inline-flex" >
                Let's Talk
