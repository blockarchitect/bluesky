<?php
$pageTitle = "Bluesky Advisors — Trusted Corporate & Financial Advisors in Dubai";
$pageDescription = "Partner with Bluesky Advisors DMCC in Dubai for corporate advisory, transaction support and business growth strategy tailored to your goals.";
include 'head.php';
?>
...
<?php $contact = 1; ?>
    ...
    <main>
      <!-- Hero Banner -->
      <div class="hero-slider hero-slider-3 with-floating-header with-fixed-bg">
        <div class="slider-card overlay">
          <picture class="slider-media">
            <source
              media="(max-width: 575px)"
              srcset="assets/img/slider/b-575.jpg"
            >
            <source
              media="(max-width: 991px)"
              srcset="assets/img/slider/b-991.jpg"
            >
            <img
              src="assets/img/slider/b1.jpg"
              width="1920"
              height="1000"
              loading="eager"
              alt="Hero Image"
          ...
          <div class="slider-content">
            <div
              class="container height-100 d-flex align-items-center justify-content-center text-center"
            >
      ...
      <!-- Multicolmun -->
      <div class="multicolumn multicolumn-page section-padding">
        <div class="container">
          ...
          <div class="multicolumn-inner section-content">
            <div class="row product-grid">
              <div class="col-xl-4 col-md-6 col-12" data-aos="fade-up">
                ...
                >
                  ...
                  <h2 class="heading text-28">Business Consulting</h2>
              ...
              >
                ...
                >
                  ...
                  <h2 class="heading text-28">Risk Management</h2>
                  <div class="text text-16">
                    See how our tailored solutions can boost your business. From
                    planning to support.
                  </div>
        ...
        <div class="container-fluid">
          <div class="text-banner-inner radius18">
            <div class="section-headings">
              ...
              <h2 class="heading text-80" data-aos="fade-up">
                Thriving on consistent, subscription-based revenue.
              </h2>
              <p class="text text-24" data-aos="fade-up">
